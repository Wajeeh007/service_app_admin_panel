...
class _GoogleMapWidgetState extends State<GoogleMapWidget> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      try {
        ...
        if (mounted) {
          setState(() {
            _mapReady = true;
            Future.delayed(Duration(milliseconds: 500), () => _drawPolygons(_gMap));
          });
        }
      } catch (e) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      addListener(drawingManager, 'overlaycomplete', js.allowInterop((e) {
        ...
        if (widget.isBeingEdited) {
          ...
          widget.zoneListViewModel.areaPolygons = polygonWKT;
        }
  ...
  void _moveCamera(GMap map, dynamic rawMap) async {
    try{
