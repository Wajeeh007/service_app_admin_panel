                ...
                child: Row(
                  children: [
                    ...
                    ListActionsButtons(
                        ...
                        includeEdit: false,
                        includeView: true,
                      onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visibleAllOrdersList[index]}),
                    )
                  ],
                ),
              );
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    ...
                    ListEntryItem(text: _viewModel.visiblePendingOrdersList[index].serviceItem?.name,),
                    ...
                    ListActionsButtons(
                      ...
                      includeEdit: false,
                      includeView: true,
                      onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visiblePendingOrdersList[index]}),
                    )
                  ],
                ),
              );
                ...
                child: Row(
                  children: [
                    ...
                    ListActionsButtons(
                      ...
                      includeEdit: false,
                      includeView: true,
                      onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visibleAcceptedOrdersList[index]}),
                    )
                  ],
                ),
              );
              ...
              child: Row(
                children: [
                  ...
                  ListActionsButtons(
                    ...
                    includeEdit: false,
                    includeView: true,
                    onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visibleOngoingOrdersList[index]}),
                  )
                ],
              ),
            );
              ...
              child: Row(
                children: [
                  ...
                  ListActionsButtons(
                    ...
                    includeEdit: false,
                    includeView: true,
                    onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visibleCompletedOrdersList[index]}),
                  )
                ],
              ),
            );
              ...
              child: Row(
                children: [
                  ...
                  ListActionsButtons(
                    ...
                    includeEdit: false,
                    includeView: true,
                    onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visibleCancelledOrdersList[index]}),
                  )
                ],
              ),
            );
              ...
              child: Row(
                children: [
                  ...
                  ListActionsButtons(
                    ...
                    includeEdit: false,
                    includeView: true,
                    onViewPressed: () => Get.toNamed(Routes.orderDetails, arguments: {'orderDetails': _viewModel.visibleDisputedOrdersList[index]}),
                  )
                ],
              ),
            );
